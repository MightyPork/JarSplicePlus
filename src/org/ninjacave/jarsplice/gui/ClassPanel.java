...
public class ClassPanel extends JPanel implements ActionListener {
	...
	public ClassPanel(JarSpliceFrame jarSplice)
	{
		...
		final TitledBorder border = BorderFactory.createTitledBorder("Set Main Class");
	...
	{
		final JPanel mainClassBox = new JPanel();
		mainClassBox.setLayout(new BorderLayout(5, 5));
		final TitledBorder border1 = BorderFactory.createTitledBorder("Enter Main Class");
		mainClassBox.setBorder(border1);
		
		final JPanel centerPanel1 = new JPanel();
		final JLabel label = new JLabel();
		label.setText(String.format(
				"<html><div style=\"width:%dpx;\">%s</div><html>",
				new Object[] { Integer.valueOf(300),
		...
		final JPanel centerPanel2 = new JPanel();
		...
		final JPanel centerPanel3 = new JPanel();
	...
	{
		final JPanel vmArgBox = new JPanel();
		vmArgBox.setLayout(new BorderLayout(5, 5));
		final TitledBorder border2 = BorderFactory.createTitledBorder("Set VM Arguments");
		...
		final JPanel centerVmArgPanel = new JPanel();
		centerVmArgPanel.setLayout(new BorderLayout(5, 5));
		
		final JPanel centerPanel4 = new JPanel();
		...
		final JPanel centerPanel5 = new JPanel();
	...
	{
		if (e.getSource() == this.optionsButton) if (this.vmArgBox.isVisible()) {
			this.vmArgBox.setVisible(false);
